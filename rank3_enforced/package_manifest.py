...
def registry_hashes() -> dict[str, str]:
    ...
    return {
        ...
        "model_type_registry_hash": stable_json_hash(["minimal_control", "two_support_path_adjustment", "two_support_explicit_path_adjustment", "association_indexed_soo_feedback_candidate", "charge_attraction_repulsion_candidate", "gravitation_path_candidate", "charge_role_path_remap_dynamic_path_candidate", "external_path_monitor_exploratory_candidate", "modeling_intent_contract_layer", "modeling_plan_approval_layer", "certification_plan_executability_gate", "release_identity_self_consistency_gate"]),
    }
