...
def test_release_identity_report_passes_for_current_tree():
    ...
    report = check_release_identity(
        ...
        framework_zip_path=root / "releases/current/enforceable_rank3_modeling_v0.1.35_gradient_vacuum_split_planning.zip",
        framework_tar_gz_path=root / "releases/current/enforceable_rank3_modeling_v0.1.35_gradient_vacuum_split_planning.tar.gz",
    )
...
def test_framework_zip_code_hash_matches_installed_source_hash():
    ...
    zip_hash = compute_framework_zip_code_sha256(
        root / "releases/current/enforceable_rank3_modeling_v0.1.35_gradient_vacuum_split_planning.zip"
    )
