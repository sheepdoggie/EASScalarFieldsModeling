...
git tag -a v0.1.33 -m "v0.1.33 operator-agent approval loop"
...
python tools/verify_release_manifest.py releases/current/FRAMEWORK_RELEASE_MANIFEST.json releases/current/FRAMEWORK_RELEASE_MANIFEST.sig releases/current/FRAMEWORK_RELEASE_PUBLIC_KEY.pem releases/current/enforceable_rank3_modeling_v0.1.33_admission_control_materials.zip
```
